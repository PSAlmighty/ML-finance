...
def run():
    ...
    print "Hp score: ", sklearn.metrics.f1_score(y_testing, x_testing['HP_Trend'])
    print "MAC score: ", sklearn.metrics.f1_score(y_testing, x_testing['MAC'])
    print "Stochastic score: ", sklearn.metrics.f1_score(y_testing, x_testing['stochastic_agent5'])
    print "Candlestick Score: ", sklearn.metrics.f1_score(y_testing, x_testing['Candlestick_agent'])
